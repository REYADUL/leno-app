...
<!-- Mirrored from the100code.com/terms-conditions.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jun 2023 09:17:29 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="{{ url('/#preview') }}">PREVIEW</a>
                </li>
